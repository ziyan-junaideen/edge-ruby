...
module Edge
  # Reads `contract/manifest.yml`, the description of what the API exposes,
  # maintained from its observed behaviour. Shipping it in the gem and reading
  # it at runtime is deliberate: the redaction list in particular must come from
  # the same place the contract does, or the two drift and secrets start
  # reaching logs.
  module Contract
