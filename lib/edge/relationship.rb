...
module Edge
  ...
  class Relationship
    ...
    # route it lives at: `financial_institutions` reports another resource's
    # type.
    ...
    # specifies for a relationship link.
    ...
    # resource name the manifest records rather than the reported type, which
    # can belong to another resource entirely.
    #
    # The camel-to-snake conversion covers every such name in the manifest
