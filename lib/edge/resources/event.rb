...
module Edge
  ...
  # keeps it in two attributes:
  #
  #   resource_type  "transaction.payment_demands"
  #   slug           "succeeded"
  #
  # and joins them only internally, to match subscriptions. Neither the stored
  # event nor the webhook delivery ever carries the joined form.
  #
  ...
  # `resource_id`, `slug` and `data` and **no `created_at`**. `#id` is identity
  # in both, and is what to deduplicate on.
