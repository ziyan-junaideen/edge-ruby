...
module Edge
  ...
  # raw body, and the parsed JSON:API error objects when there were any. The API
  # does not always send JSON — auth failures come back as plain text — so
  # `errors` may be empty while `raw_body` still explains the problem.
