...
module Edge
  ...
  # text/plain, and a proxy or load balancer can return HTML for a 502. Parsing
  # is therefore always attempted and never assumed: a body that is not JSON
  # must still produce a useful typed error, not a JSON::ParserError from inside
  # the client.
  class Response
